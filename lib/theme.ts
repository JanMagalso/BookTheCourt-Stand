...
export const themeOptions = {
  ...
  red: createTheme("Red", "#c2413c", {
    colors: {
      ...
      brandSuccess: "#b73a34",
      brandSuccessStrong: "#a7312d",
      brandSuccessDeep: "#6b211d",
      brandSuccessMuted: "#bb6c64",
      brandSuccessBorder: "#f3beb7",
      brandSuccessRing: "#f8d1cb",
      brandSuccessHover: "#eaa39a",
      brandAccent: "#f59e0b",
  ...
  blue: createTheme("Blue", "#2563eb", {
    colors: {
      ...
      brandSuccess: "#2563eb",
      brandSuccessStrong: "#1d4ed8",
      brandSuccessDeep: "#173b7a",
      brandSuccessMuted: "#527fc3",
      brandSuccessBorder: "#bfd5fa",
      brandSuccessRing: "#dbe8fd",
      brandSuccessHover: "#95b7f5",
      brandAccent: "#67e8f9",
  ...
  amber: createTheme("Amber", "#c77a18", {
    colors: {
      ...
      brandSuccess: "#a56512",
      brandSuccessStrong: "#8b5610",
      brandSuccessDeep: "#5e3a12",
      brandSuccessMuted: "#b48a4e",
      brandSuccessBorder: "#edd2a0",
      brandSuccessRing: "#f5e3bf",
      brandSuccessHover: "#ddb672",
      brandAccent: "#f59e0b",
  ...
  plum: createTheme("Plum", "#7c3aed", {
    colors: {
      ...
      brandSuccess: "#7c3aed",
      brandSuccessStrong: "#6d28d9",
      brandSuccessDeep: "#412070",
      brandSuccessMuted: "#8869be",
      brandSuccessBorder: "#d8cbfb",
      brandSuccessRing: "#e8defd",
      brandSuccessHover: "#b39beb",
      brandAccent: "#f472b6",
