...
NEXT_PUBLIC_DEFAULT_THEME=green
```
...
`NEXT_PUBLIC_DEFAULT_THEME` lets a deployment choose its starting palette. Supported values are `green`, `red`, `blue`, `amber`, and `plum`. If the value is missing or invalid, the app falls back to `green`.
