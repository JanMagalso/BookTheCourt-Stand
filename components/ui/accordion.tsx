...
export function AccordionTrigger({
  ...
  return (
    ...
    >
      ...
      <span
        aria-hidden="true"
        className={`inline-flex h-9 w-9 shrink-0 items-center justify-center rounded-full border border-(--color-border-light) bg-(--color-surface) text-lg text-slate-500 transition-transform duration-200 ${item.isOpen ? "rotate-45" : ""}`.trim()}
      >
        +
      </span>
    </button>
